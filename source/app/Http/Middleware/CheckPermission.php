...
class CheckPermission
{
    ...
    public function handle(Request $request, Closure $next, $permission)
    {
        ...
        $permissionsToCheck = [
            ...
            'hasAccessRekapPemeriksaanFisik' => '',
            'hasAccessRekapVital' => '',
            'hasAccessRekapSpirometri' => '',
            'hasAccessRekapAudiometri' => '',
            'hasAccessRekapEKG' => '',
            'hasAccessRekapThreadmill' => '',
            'hasAccessRekapRontgenThorax' => '',
            'hasAccessRekapRontgenLumbosacral' => '',
            'hasAccessRekapUSGUbdomain' => '',
            'hasAccessRekapFarminghamScore' => '',
            /* Master Data */
