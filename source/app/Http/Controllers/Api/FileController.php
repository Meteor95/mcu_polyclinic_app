...
class FileController extends Controller
{
    ...
    public function download_lampiran_pdf(Request $req){
        try {
            $fileName = $req->file_name;
            $filePath = 'uploads/laboratorium/' . $fileName;
            if (!Storage::disk('public')->exists($filePath)) {
                return response()->json([
    ...
    public function download_lampiran_pdf_laboratorium(Request $req){
        try {
            $fileName = $req->file_name;
            $filePath = 'mcu/berkas/file_laboratorium/' . $fileName;
            if (!Storage::disk('public')->exists($filePath)) {
                return response()->json([
                    'error' => 'File tidak ditemukan.'
                ], Response::HTTP_NOT_FOUND);
