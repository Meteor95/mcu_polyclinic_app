            ...
            public function renderLaporanKesimpulan() {
                ...
                foreach ($pemeriksaan as $item) {
                    ...
                    if ($item['label'] === "PEMERIKSAAN MATA") {
                        ...
                        $nilaiJauhOD_tanpa = $p->visus_od_tanpa_kacamata_jauh;
                        $nilaiJauhOS_tanpa = $p->visus_od_tanpa_kacamata_jauh;
                        $nilaiDekatOD_tanpa = $p->visus_od_tanpa_kacamata_dekat;
                        $nilaiDekatOS_tanpa = $p->visus_od_tanpa_kacamata_dekat;
                        ...
                        $this->SetFont('Times', '', 10);  $this->Write(6, ($nilaiJauhOS_tanpa ?? '-') . ' '.$text_pakai_kacamata_tanpa);
            ...
            public function poliRontgenThorax(){
                foreach ($this->data['all_citra_data']->groupBy('jenis_poli') as $jenis_poli => $dataPoli) {
                    ...
                    if ($cek_poli === "POLI_RONTGEN_LUMBOSACRAL") {
                        ...
                        $fields = [
                            'Foto Lumbosacral AP/Lateral'     => 'USE_HTML_CONTENT', 
                            'Kesan'      => $firstItem->catatan_kaki ?? '-',
                        ];                     
                        $originalMargin = $this->lMargin;
