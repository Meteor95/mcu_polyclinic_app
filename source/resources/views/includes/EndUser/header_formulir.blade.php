<div class="sticky-header">
    <header>                       
        ...
        <div class="navbar-collapse justify-content-center collapse hidenav" id="navbarDefault">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ env('URL_MANDIRI_DOMAIN')}}" onclick="document.getElementById('formulir_mcu').scrollIntoView({ behavior: 'smooth' });">Formulir MCU</a>
            </li>
