      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive theme-scrollbar">
                <table class="display" id="datatables_ekg_perusahaan"></table>
            </div>
          </div>
        </div>
      </div>
...
<script src="{{ asset('vendor/erayadigital/laporan/rekap_ekg.js') }}?v={{ filemtime(public_path('vendor/erayadigital/laporan/rekap_ekg.js')) }}"></script>
@endsection