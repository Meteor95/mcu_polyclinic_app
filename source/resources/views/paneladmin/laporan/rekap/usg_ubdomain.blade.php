      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive theme-scrollbar">
                <table class="display" id="datatables_usg_ubdomain_perusahaan"></table>
            </div>
          </div>
        </div>
      </div>
...
<script src="{{ asset('vendor/erayadigital/laporan/rekap_usg_ubdomain.js') }}?v={{ filemtime(public_path('vendor/erayadigital/laporan/rekap_usg_ubdomain.js')) }}"></script>
@endsection