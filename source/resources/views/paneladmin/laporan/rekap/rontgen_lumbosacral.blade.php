    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h4>Rekap Pemeriksaan Rontgen Lumbosacral Pada Perusahaan</h4><span>Pada tabel ini adalah rekap pemeriksaan Rontgen Lumbosacral pada perusahaan, silahkan pilih perusahaan dan periode untuk melihat rekap pemeriksaan tanda vital. Jadi nantinya tim AMC dapat melihat seberapa banyak perusahaan mengirimkan pegawainya untuk dicek kesehatannya di AMC ini</span>
        </div>
        <div class="card-body">
            <div class="row mb-2">
              <div class="col-md-6">
            ...
            <div class="table-responsive theme-scrollbar">
                <table class="display" id="datatables_rontgen_lumbosacral_perusahaan"></table>
            </div>
          </div>
        </div>
      </div>
...
<script src="{{ asset('vendor/erayadigital/laporan/rekap_rontgen_lumbosacral.js') }}?v={{ filemtime(public_path('vendor/erayadigital/laporan/rekap_rontgen_lumbosacral.js')) }}"></script>
@endsection