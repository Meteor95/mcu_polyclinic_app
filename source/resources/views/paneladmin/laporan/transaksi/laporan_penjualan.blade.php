  ...
  <div class="modal-dialog modal-fullscreen" role="document">
      <div class="modal-content">
          ...
          <div class="modal-footer">
            <div class="row" id="footer_total" style="display: none;">
              <div class="col-12">
...
<script src="{{ asset('vendor/erayadigital/laporan/laporan_penjualan.js') }}?v={{ filemtime(public_path('vendor/erayadigital/laporan/laporan_penjualan.js')) }}"></script>
@endsection