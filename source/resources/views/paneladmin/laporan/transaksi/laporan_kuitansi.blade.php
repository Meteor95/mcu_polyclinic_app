    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h4>Cetak Kuitansi Untuk Peserta {{ config('app.name') }}</h4><span>
          Fitur Cetak Kuitansi untuk Peserta memungkinkan pengguna untuk mencetak kuitansi pembayaran secara otomatis berdasarkan data transaksi yang telah dilakukan. Dengan fitur ini, setiap peserta yang telah menyelesaikan pembayaran dapat menerima kuitansi resmi sebagai bukti transaksi.Fitur ini dirancang untuk mempermudah pengelolaan transaksi serta memberikan kemudahan bagi peserta dalam mendapatkan bukti pembayaran mereka.
          </span>
        </div>
        <div class="card-body">
            <div class="row">
                        ...
                        <div class="card-body p-0">
                          <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center" role="alert">
                              ...
                              <div class="flex-grow-1 text-truncate">
                                  Cetak Kuitansi Format <b>Personal</b>
                              </div>
                          </div>
                          <div class="row align-items-end">
                              <div class="col-sm-8">
                                  <div class="p-3">
                                      <p class="fs-16 lh-base">Informasikan bukti pembayaran kepada peserta <span class="fw-semibold">Format Personal</span>, "Tindakan MCU atau NON MCU" <i class="mdi mdi-arrow-right"></i></p>
                                      <div class="mt-3">
                                          <a href="javascript:void(0)" id="btn_kuitansi_personal" class="btn btn-success" onclick="report_show_modal('kuitansi_personal',this.id)">Lihat Berkas!</a>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-sm-4">
                                  <img src="{{ asset('mofi/assets/images/gif/past-due-final-notice.gif')}}" class="card-img-top" alt="Icon cetak kuitansi personl">
                              </div>
                          </div>
                      </div> <!-- end card-body-->
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                          <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center" role="alert">
                              <i class="fa-solid fa-triangle-exclamation"></i>
                              <div class="flex-grow-1 text-truncate">
                                  Cetak Kuitansi Format <b>Perusahaan</b>
                              </div>
                          </div>
                          <div class="row align-items-end">
                              <div class="col-sm-8">
                                  <div class="p-3">
                                      <p class="fs-16 lh-base">Informasikan bukti pembayaran kepada rekanan perusahaan dengan <span class="fw-semibold">Format Perusahaan</span> <i class="mdi mdi-arrow-right"></i></p>
                                      <div class="mt-3">
                                          <a href="javascript:void(0)" id="btn_kuitansi_perusahaan" class="btn btn-success" onclick="report_show_modal('kuitansi_perusahaan',this.id)">Lihat Berkas!</a>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-sm-4">
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                          <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center" role="alert">
                              <i class="fa-solid fa-triangle-exclamation"></i>
                              <div class="flex-grow-1 text-truncate">
                                  Cetak Tagihan Format <b>Perusahaan</b>
                              </div>
                          </div>
                          <div class="row align-items-end">
                              <div class="col-sm-8">
                                  <div class="p-3">
                                      <p class="fs-16 lh-base">Informasikan bukti tagihan kepada rekanan perusahaan dengan <span class="fw-semibold">Format Perusahaan </span> <i class="mdi mdi-arrow-right"></i></p>
                                      <div class="mt-3">
                                          <a href="javascript:void(0)" id="btn_tagihan_perusahaan" class="btn btn-success" onclick="report_show_modal('tagihan_perusahaan',this.id)">Lihat Berkas!</a>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-sm-4">
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                          <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center" role="alert">
                              <i class="fa-solid fa-triangle-exclamation"></i>
                              <div class="flex-grow-1 text-truncate">
                                  Cetak Pelaksana Tindakan <b>Peserta</b>
                              </div>
                          </div>
                          <div class="row align-items-end">
                              <div class="col-sm-8">
                                  <div class="p-3">
                                      <p class="fs-16 lh-base">Informasikan peserta atas tindakan peserta yang terdaftar <span class="fw-semibold">Format Perusahaan</span> <i class="mdi mdi-arrow-right"></i></p>
                                      <div class="mt-3">
                                          <a href="javascript:void(0)" id="btn_tagihan_peserta" class="btn btn-success" onclick="report_show_modal('tagihan_peserta',this.id)">Lihat Berkas!</a>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-sm-4">
  ...
  <div class="modal-dialog modal-fullscreen" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="report_show_modalLabel">Berkas Cetak Kuitansi </h5>
          ...
          <div class="modal-body">
            ...
            <div class="row">
                <div class="col-12">
                    <table id="datatables_laporan_kuitansi" class="table table-bordered table-striped table-hover table-padding-sm"></table>
                </div>
            </div>
          </div>
