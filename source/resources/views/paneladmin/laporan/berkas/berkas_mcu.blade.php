...
<script src="{{ asset('vendor/erayadigital/laporan/berkas_mcu_perusahaan.js') }}?v={{ filemtime(public_path('vendor/erayadigital/laporan/berkas_mcu_perusahaan.js')) }}"></script>
@else
