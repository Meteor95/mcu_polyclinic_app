...
<style>
.header,.section{margin-bottom:0}.header,footer{position:fixed}#medical-checkup-table,.lapang_pandang_table,.tabel_riwayat{border-collapse:collapse}@page{margin:110px 0 80px 40px}@page:first{margin:0}.header{margin-top:-120px}main{margin-right:25px}.break-before{page-break-after:auto}.judul_kondisi_fisik,.judul_riwayat{text-align:left;color:#fff;border-radius:10px;margin-bottom:5px;display:inline-block}.judul_riwayat{background-color:#f1491f;padding:5px}.judul_kondisi_fisik{margin-top:0;background-color:#4ab1c7;padding:10px}.box,.lapang_pandang_table td,.lapang_pandang_table th,.lapang_pandang_table tr{border:1px solid #000}footer{bottom:-70px;left:0;right:0;text-align:center;font-size:13px;z-index:103}background_bottom{position:fixed;bottom:-90px;left:-50px;z-index:-1;opacity:.6}#medical-checkup-table{width:100%;margin-bottom:10px;font-size:13px}#medical-checkup-table td,#medical-checkup-table th{border:1px solid #000;padding:5px}.box{display:inline-block;width:15px;height:15px;margin-right:5px;vertical-align:middle}.sehat-resiko-ringan{background-color:#ff0}.sehat{background-color:#90ee90}.resiko-sedang-tinggi{background-color:orange}.tidak-sehat{background-color:#f8786e}.tabel_riwayat tr:nth-child(2n){background-color:#f2f2f2}.tabel_riwayat tr:nth-child(odd){background-color:#fff}.cover,.cover_back{width:100%;height:100%;z-index:999}
</style>
</head>
<body>
    @php
