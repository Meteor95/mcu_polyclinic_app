    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h4>Formulir Pendaftaran Peserta MCU</h4>
                <span>Silahkan isikan informasi yang valid agar dapat melakukan pendaftaran peserta MCU. Jika ada informasi yang tidak valid maka petugas dapat melakukan koreksi sebelum data benar-benar disimpan ke dalam sistem MCU Arta Medica.</span>
            </div>
            <div class="card-body">
                ...
                <form id="formulir_pendaftaran_peserta">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div id="pilih_departemen">
                                <select class="form-select" id="select2_departemen" name="select2_departemen" required></select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div id="pilih_paket_mcu">
                                <select class="form-select" id="select2_paket_mcu" name="select2_paket_mcu" required></select>
                            </div>
                        </div>
                        <div class="col-md-12">
