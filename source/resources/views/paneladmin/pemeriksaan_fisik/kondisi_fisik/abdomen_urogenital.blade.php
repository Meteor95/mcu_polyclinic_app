    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
            @include('komponen.information_user', ['title_card' => 'Kondisi Fisik '.ucwords(str_replace('_', ' & ', $data['lokasi_fisik'])), 'informasi_apa' => "informasi kondisi fisik ".strtolower($data['lokasi_fisik'])])
        </div>
        <div class="card-body">
            <div class="row">
