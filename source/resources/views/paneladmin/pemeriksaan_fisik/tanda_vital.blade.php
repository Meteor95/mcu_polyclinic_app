  ...
  <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
          ...
          <div class="modal-body">
            <h5 id="bmi_informasi">0</h2>
            <h5 id="status_gizi_informasi">0</h2>
            <h1>Tanda Vital</h1>
...
<script src="{{ asset('vendor/erayadigital/tingkatkesadaran/tandavital.js') }}?v={{ filemtime(public_path('vendor/erayadigital/tingkatkesadaran/tandavital.js')) }}"></script>
<script>
