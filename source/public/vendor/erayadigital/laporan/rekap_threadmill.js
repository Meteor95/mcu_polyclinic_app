...
$("#btn_baca_data_rekap").on('click', function() {
    $("#datatables_threadmill_perusahaan").DataTable().ajax.reload();
});
function loadDataPasien() {
    $.get('/generate-csrf-token', function(response) {
        if ($.fn.DataTable.isDataTable('#datatables_threadmill_perusahaan')) {
            $("#datatables_threadmill_perusahaan").DataTable().destroy();
            $("#datatables_threadmill_perusahaan").empty();
        }
        $("#datatables_threadmill_perusahaan").DataTable({
            searching: false,
            lengthChange: false,
            ordering: false,
            bFilter: false,
            ...
            ajax: {
                "url": baseurlapi + '/laporan/rekap/threadmill',
                "type": "GET",
