        ...
        $("#datatables_daftarpasien").DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        if (type === 'display') {
                            return `<div class="d-flex justify-content-between gap-2"><button onclick="lihat_berkas_mcu('${row.no_transaksi}', '${row.nama_peserta}', '${row.id}',this)" class="btn btn-danger w-100"><i class="fa fa-print"></i> Lihat Berkas</button></div>`;
                        }       
                        return data;
                    }
                }
            ...
            success: function(response) {
                ...
                try {
                    ...
                    if (!data || data === "TIDAK ADA") {
                        ...
                        quillInstances['editor_riwayat_kecelakaan_kerja'].setText(data);
                    }
                }
                ...
                $('#buta_warna_modal').text(response.penglihatan.buta_warna == 1 ? "Color Blind" : "Normal");
                $('#buta_warna_red_green_modal').text(response.penglihatan.buta_warna_red_green == 1 ? "Red Green" : "Normal");
                $("#buta_warna_keterangan_modal").text("("+response.penglihatan.buta_warna_keterangan+")");
