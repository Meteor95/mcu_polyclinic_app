...
$("#btn_baca_data_rekap").on('click', function() {
    $("#datatables_spirometri_perusahaan").DataTable().ajax.reload();
});
function loadDataPasien() {
    $.get('/generate-csrf-token', function(response) {
        if ($.fn.DataTable.isDataTable('#datatables_spirometri_perusahaan')) {
            $("#datatables_spirometri_perusahaan").DataTable().destroy();
            $("#datatables_spirometri_perusahaan").empty();
        }
        $("#datatables_spirometri_perusahaan").DataTable({
            searching: false,
            lengthChange: false,
            ordering: false,
            bFilter: false,
            ...
            ajax: {
                "url": baseurlapi + '/laporan/rekap/spirometri',
                "type": "GET",
