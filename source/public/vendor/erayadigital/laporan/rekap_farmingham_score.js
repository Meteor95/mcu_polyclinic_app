...
$("#btn_baca_data_rekap").on('click', function() {
    $("#datatables_farmingham_score_perusahaan").DataTable().ajax.reload();
});
function loadDataPasien() {
    $.get('/generate-csrf-token', function(response) {
        if ($.fn.DataTable.isDataTable('#datatables_farmingham_score_perusahaan')) {
            $("#datatables_farmingham_score_perusahaan").DataTable().destroy();
            $("#datatables_farmingham_score_perusahaan").empty();
        }
        $("#datatables_farmingham_score_perusahaan").DataTable({
            searching: false,
            lengthChange: false,
            ordering: false,
            bFilter: false,
            ...
            ajax: {
                "url": baseurlapi + '/laporan/rekap/farmingham_score',
                "type": "GET",
